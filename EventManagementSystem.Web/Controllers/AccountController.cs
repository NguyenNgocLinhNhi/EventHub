...
namespace EventManagementSystem.Web.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register()
        {
            ...
            // Nạp danh sách đăng nhập ngoài (Google/Facebook) cho View
        ...
        public async Task<IActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // Chuyển đến trang thông báo vui lòng kiểm tra email
            ...
            // Nếu lỗi, nạp lại ExternalLogins trước khi trả về View
            ViewBag.ExternalLogins = (await _signInManager.GetExternalAuthenticationSchemesAsync()).ToList();
            return View(model);
        }
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string? returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (user != null)
                {
                    ...
                    // 2. CHẶN TỔ CHỨC: Không đăng nhập tại cổng User
